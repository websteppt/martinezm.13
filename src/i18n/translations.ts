...
export const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    // Collections
    'collection.col1.product3.name': 'Produto 3',
    'collection.col1.product3.description': 'Descrição do produto 3.',
    'collection.col1.product4.name': 'Produto 4',
    'collection.col1.product4.description': 'Descrição do produto 4.',
    'collection.col1.product5.name': 'Produto 5',
    'collection.col1.product5.description': 'Descrição do produto 5.',
    'collection.col1.product6.name': 'Produto 6',
    'collection.col1.product6.description': 'Descrição do produto 6.',
    'collection.col1.product7.name': 'Produto 7',
    'collection.col1.product7.description': 'Descrição do produto 7.',
  ...
  en: {
    ...
    // Collections
    'collection.col1.product3.name': 'Product 3',
    'collection.col1.product3.description': 'Product 3 description.',
    'collection.col1.product4.name': 'Product 4',
    'collection.col1.product4.description': 'Product 4 description.',
    'collection.col1.product5.name': 'Product 5',
    'collection.col1.product5.description': 'Product 5 description.',
    'collection.col1.product6.name': 'Product 6',
    'collection.col1.product6.description': 'Product 6 description.',
    'collection.col1.product7.name': 'Product 7',
    'collection.col1.product7.description': 'Product 7 description.',
    // Custom Orders
