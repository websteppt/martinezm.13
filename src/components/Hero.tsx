...
export default function Hero() {
  ...
  return (
    <>
      <Helmet>
        <title>M Signature — Elegância Premium</title>
        <meta name="description" content="M Signature — marca de luxo premium. Descubra a nossa coleção exclusiva de painéis e encomendas personalizadas." />
        <link rel="canonical" href="https://msignature.pt/" />
      </Helmet>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-24 left-4 sm:top-28 sm:left-8 w-12 h-12 sm:w-16 sm:h-16 border-l border-t border-gold-500/30" />
        <div className="absolute top-24 right-4 sm:top-28 sm:right-8 w-12 h-12 sm:w-16 sm:h-16 border-r border-t border-gold-500/30" />
        <div className="absolute bottom-8 left-4 sm:left-8 w-12 h-12 sm:w-16 sm:h-16 border-l border-b border-gold-500/30" />
        <div className="absolute bottom-8 right-4 sm:right-8 w-12 h-12 sm:w-16 sm:h-16 border-r border-b border-gold-500/30" />
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <h1 className="font-display tracking-[0.05em] leading-tight mb-6 animate-fade-in-up">
            ...
            <span className="text-midnight-100 font-light text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-[0.15em] block -mt-0 sm:-mt-2 md:-mt-3 lg:-mt-4">{t('hero.subBrand')}</span>
          </h1>
